		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#worklistfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"worklistfreestyle-display": {
								"semanticObject": "worklistfreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=worklist.freestyle",
									"url": sap.ui.require.toUrl("worklist/freestyle")
								}
							}
						}
					}
