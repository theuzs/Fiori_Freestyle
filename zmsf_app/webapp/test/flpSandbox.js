		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#moovizmsfapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovizmsfapp-display": {
								"semanticObject": "moovizmsfapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.zmsfapp",
									"url": sap.ui.require.toUrl("moovi/zmsfapp")
								}
							}
						}
					}
